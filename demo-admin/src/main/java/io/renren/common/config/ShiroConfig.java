...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        //added by wangjh
        filterMap.put("/sys/dauser/login", "anon");
        filterMap.put("/sys/dauser/updPassword", "anon");
        filterMap.put("/sys/daquery/querypoints", "anon");
        filterMap.put("/sys/daquery/querynews", "anon");
